...
public class SEGI : MonoBehaviour
{
    ...
    public static AssetBundle Bundle => _bundle ?? (_bundle = BundleManager.GetAssetBundle("segi"));
...
#region SupportingObjectsAndProperties
	...
	void Init()
	{
		...
		mipFilterCompute = Bundle.LoadAsset<ComputeShader>("SEGIMipFilter") as ComputeShader;
